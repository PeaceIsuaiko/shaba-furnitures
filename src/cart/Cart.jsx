...
function Cart() {
  ...
  const updateTotal = (cartData) => {
    ...
    setTotalPrice(newSubTotal + newShipping);
  };
  ...
  const handleCheckout = () => {
    ...
    localStorage.setItem('checkoutItems', JSON.stringify(cartNames));
    navigate('/checkout');
  };
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="flex gap-2 mt-2 text-white font-bold">
                    ...
                    <span className="px-2 text-yellow-800">{product.quantity}</span>
                    <button
                ...
                <button className="px-4 mb-8" onClick={() => handleRemoveProduct(product.id)}>
                  <svg className="w-8 h-8 text-yellow-800" xmlns="http://www.w3.org/2000/svg" fill="none"
